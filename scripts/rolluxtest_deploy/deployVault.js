...
async function main() {
  ...
  await sendTxn(glp.setMinter(glpManager.address, true), `glp.setMinter(${glpManager.address})`);
  await sendTxn(usdg.addVault(glpManager.address), `usdg.addVault(${glpManager.address})`);
  ...
  await sendTxn(vault.setManager(glpManager.address, true), `vault.setManager(${glpManager.address})`);
